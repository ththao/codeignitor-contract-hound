...
<html dir="ltr" lang="en-US">
	<head>
		...
		<title>Upload New Contract Version | Contract Hound</title>
	...
	<body ng-app="ContractHoundApp">
				...
				<div class="modal-dialog">
					<div class="modal-content main-upload">
						<div class="modal-header">
							...
							<h3 class="modal-title">Upload a New Version</h3>
							<p>Upload a new version of this contract. Contracts should be in a PDF or DOC format.</p>
						</div>
							...
							<div class="row">
								<div class="col-sm-8" full>
									<div class="row">
										...
										<div class="col-xs-7">
											<h4>Drag &amp; Drop</h4>
											<p class="help-block">You can upload a new contract version by dragging &amp; dropping the file into this window.</p>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
		...
		<script>
			...
			var drop = new Dropzone("body",
				{
					url : '/contracts/upload_file_version_ajax/<?php echo $oContract->contract_id; ?>',
