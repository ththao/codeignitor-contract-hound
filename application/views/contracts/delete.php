...
<html dir="ltr" lang="en-US">
	...
	<head>
		...
		<title>Delete Contract | Contract Hound</title>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h3 class="modal-title">Delete this Contract?</h3>
							<p>Are you sure you want to delete this contract? When you delete this contract, all messages, reminders, and notifications will cease.</p>
						</div>
						<div class="modal-footer modal-footer-left">
							<a href="/contracts/delete/<?php echo $oContract->contract_id; ?>?cdc=1" class="btn btn-lg btn-danger">Delete Contract</a>
