...
<html dir="ltr" lang="en-US">
	...
	<head>
		...
		<title>Limited Access | Contract Hound</title>
				...
				<div class="modal-dialog">
					<div class="modal-content" >
						<div class="modal-header modal-header-ad background-orange text-white">
							...
							<h3 class="modal-title">Limited Access</h3>
						</div>
						<div class="modal-body">
							<div class="text-large">
								<p>Please contact the account owner,  <?php echud($sParentEmail); ?> to upgrade this account.</p>
							</div>
						</div>
						<div class="modal-footer">
							<a href="/welcome" class="btn btn-default btn-lg">Close</a>
						</div>
					</div>
				</div>
			</div>
