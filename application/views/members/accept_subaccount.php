...
<html dir="ltr" lang="en-US">
	<head>
	    ...
	    <title>Create Account | Contract Hound</title>
		            ...
		            <div class="intercept-frame">
		                <div class="login">
		                    ...
		                    <div class="login-header">
		                        ...
		                        <p>To be added as a user to <?php echud($sTeamName); ?>'s account, please create and verify your password below.</p>
		                    </div>
		                    <form class="login-form" method="POST">
		                        <input type="hidden" name="cfmtk" value="<?=$sConfirmationToken?>">
		                            ...
		                            <table>
		                                ...
		                                <tr>
		                                    ...
		                                    <td class="form-response">
		                                        <p class="form-control-static input-lg"><?php echud($sMemberEmail); ?></p>
		                                    </td>
		                                </tr>
		                                <tr>
		                                    <td class="form-label">
		                                    ...
		                                    <td class="form-response">
		                                        <input name="password" class="form-control input-lg" type="password" placeholder="&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;" />
		                                    </td>
		                                </tr>
		                                <tr>
		                                    <td class="form-label">
		                                    ...
		                                    <td class="form-response">
		                                        <input name="confirm_password" class="form-control input-lg" type="password" placeholder="&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;" />
		                    ...
		                    <div class="login-extra">
		                        <p class="help-block">By logging in, you agree to the Contract Hound <a href="#">Terms of Service</a>.</p>
