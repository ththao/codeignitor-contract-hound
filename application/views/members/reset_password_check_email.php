...
<html dir="ltr" lang="en-US">
	...
	<head>
		...
		<title>Email Sent | ContractHound</title>
					...
					<div class="intercept-frame">
						<div class="login">
							...
							<div class="login-header">
								...
								<p>We've sent you a link. Please click this link to change your password and we'll get you back into your account.</p>
							</div>
							
							<form class="login-form">
								<div class="login-form-footer">
									<div class="login-form-footer-item">
										<a href="/members/request_reset_password" class="btn btn-default btn-lg">Resend Password Reset</a>
									</div>
								</div>
							</form>
