...
<html dir="ltr" lang="en-US">
	...
	<head>
		...
		<title>Resend Activation Email | Contract Hound</title>
					...
					<div class="intercept-frame">
						<div class="login">
							<div class="login-header">
								...
								<p>Let's get you back on track. Enter your email address below, and we'll send you a link to activate your login.</p>
							</div>
							
							<form class="login-form" method="post" action="/members/resend_confirmation_token">
								<h6>Email Address</h6>
								<input type="text" name="email" class="form-control input-lg" />
		
								<div class="login-form-footer">
									<div class="login-form-footer-item">
										<input type="submit" class="btn btn-warning btn-lg" value="Resend Activation Email" />
									</div>
								</div>
							<form>
