				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h3 class="modal-title" data-error="database">Error: D1</h3>
						</div>
						<div class="modal-body">
							<p>We have had an error, please click one of the other links to continue or contact support. Code: d1sd</p>
