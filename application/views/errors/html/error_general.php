				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h3 class="modal-title">Error: GE</h3>
						</div>
						<div class="modal-body">
							<p>We have had an error, please click one of the other links to continue or contact support. Code: ge2</p>
