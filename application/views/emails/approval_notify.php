                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="padding center" style="border-collapse: collapse; font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; color: rgb(51, 51, 51); padding: 30px 8%; text-align: center;">
                                                                    <h1 style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(51, 51, 51); padding: 0px; margin: 12px 0px; font-size: 39.8131px; line-height: 1.25; text-align: center;">Approve/Reject Contract</h1>
                                                                    <hr style="border-width: 1px; border-style: solid; border-color: rgb(230, 235, 239) white white; border-image: initial; background: transparent; outline: 0px; padding: 0px; margin: 40px 0px; text-align: center;">

                                                                    <h5 style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(51, 51, 51); padding: 0px; margin: 12px 0px; font-size: 19.2px; line-height: 1.45; text-align: center;"><?php echud($sUploaderName); ?> has uploaded the contract <?php echud($sFilename); ?> on <?php echo $sDate; ?>. Please click the button below to view and approve or reject this contract. Remember, if you'd like to collaborate with your team on this contract you can post and answer questions within the chat box on the contract details page.</h5><a href="<?= site_url(); ?>contracts/view/<?php echo $iContractId; ?>" class="btn btn-primary" style="text-decoration: none; padding: 0px; margin: 12px 0px; font-size: 16px; border-radius: 400px; border-style: solid; border-image: initial; border-width: 6px 18px 8px; display: inline-block; background: rgb(6, 182, 138); border-color: rgb(6, 182, 138); color: white; font-weight: bold; text-align: center;">View Contract</a>

                                                                    <p class="meta" style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; padding: 0px; margin: 12px 0px; color: rgb(144, 159, 174); font-style: oblique; text-align: center;">If you believe you have received this message in error, please contact customer support at <a href="mailto:support@contracthound.com" style="color: rgb(6, 182, 138); text-decoration: none; font-style: oblique; text-align: center;">support@contracthound.com</a>.</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
