...
<body style="margin: 0px; padding: 0px; border-radius: 5px; background: rgb(244, 247, 251);">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="padding center" style="border-collapse: collapse; font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; color: rgb(51, 51, 51); padding: 30px 8%; text-align: center;">
                                                                    <h1 style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(51, 51, 51); padding: 0px; margin: 12px 0px; font-size: 39.8131px; line-height: 1.25; text-align: center;">Reset your password</h1>
                                                                    ...
                                                                    <p style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; color: rgb(51, 51, 51); padding: 0px; margin: 12px 0px; text-align: center;">We received a request to reset your password. If you requested a password reset for <a href="<?php echo $sResetLink; ?>" style="color: rgb(6, 182, 138); text-decoration: none; font-style: oblique; text-align: center;"><?php echud($sEmail); ?></a>, click the link below.</p><a href="<?php echo $sResetLink; ?>" class="btn btn-primary" style="text-decoration: none; padding: 0px; margin: 12px 0px; font-size: 16px; border-radius: 400px; border-style: solid; border-width: 6px 18px 8px; display: inline-block; border-color: rgb(6, 182, 138); color: white; font-weight: bold; text-align: center; background: rgb(6, 182, 138);">Reset Password</a>

                                                                    <p class="meta" style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; padding: 0px; margin: 12px 0px; color: rgb(144, 159, 174); font-style: oblique; text-align: center;">If you did not make this request, you can safely ignore this message.</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
    ...
    <div id="LAMvXo68kc_lIitRN1Xv7MG5J" class="aGJjihxRydKanuBT" style="display: none;"></div>

    <div id="POBqt0SPsgAMgO416" class="aGJjihxRydKanuBT" style="display: none;"></div>

    <div id="J1DHQvEd0hFRWVIcY" class="aGJjihxRydKanuBT" style="display: none;"></div>
</body>
</html>
