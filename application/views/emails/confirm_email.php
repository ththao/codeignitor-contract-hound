...
<html dir="ltr" lang="en-US">
	<head>
	    ...
	    <title>Confirm Your Email | Contract Hound</title>
	                                                        ...
	                                                        <tbody>
	                                                            <tr>
	                                                                <td class="padding center" style="border-collapse: collapse; font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; color: rgb(51, 51, 51); padding: 30px 8%; text-align: center;">
	                                                                    <h1 style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(51, 51, 51); padding: 0px; margin: 12px 0px; font-size: 39.8131px; line-height: 1.25; text-align: center;">Confirm Your Email</h1>
	                                                                    ...
	                                                                    <p class="meta" style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 1.5; padding: 0px; margin: 12px 0px; color: rgb(144, 159, 174); font-style: oblique; text-align: center;">You're one click away from simplifying your contract management process. Click the link below to confirm your email address and get started with Contract Hound.</p><a href="<?php echo $sConfirmationLink; ?>" class="btn btn-primary" style="text-decoration: none; padding: 0px; margin: 12px 0px; font-size: 16px; border-radius: 400px; border-style: solid; border-image: initial; border-width: 6px 18px 8px; display: inline-block; background: rgb(6, 182, 138); border-color: rgb(6, 182, 138); color: white; font-weight: bold; text-align: center;">Confirm Email</a>
	                                                                </td>
	                                                            </tr>
	                                                        </tbody>
	                                                    </table>
