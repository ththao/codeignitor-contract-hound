...
<html dir="ltr" lang="en-US">
	...
	<head>
		...
		<title><?php if (!empty($sHeader)) { echo $sHeader.' | '; } ?>ContractHound</title>
		...
		<link rel="stylesheet" type="text/css" href="/ui/css/app.4.css" />
	...
	<body ng-app="ContractHoundApp">
		<div class="layout">
			<div class="layout-framework" data-layout="[[layout]]">
